...
\begin{align*}
  \text{Goal: Prove knowledge of } x \text{ such that } X = g^x \text{ (mod } p) \text{ without revealing } x.
\end{align*}
\begin{itemize}
  \item \textbf{Setup:} Public parameters $(g, p, q)$ where $g$ generates a group of prime order $q$.
